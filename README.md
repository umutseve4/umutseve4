...
| Kanıt & sürüm | [RevisionLedger](https://github.com/umutseve4/RevisionLedger) | Dün açıklanan rakam, bugünkü revizyondan önce neydi? |
...
| Gerçek zamanlı grafik | [canakkale-1915-webgl](https://github.com/umutseve4/canakkale-1915-webgl) · [neon-lunapark-webgl](https://github.com/umutseve4/neon-lunapark-webgl) | Tek dosya, sıfır varlık, ne kadarını taşır? |
...
- `econ-lakehouse` varsayılan olarak canlı akışa bağlı değil; sentetik fixture üzerinde çalışır. Üst kaynak `TP.FG.J0` **2026-01**'de donmuş durumda ve CI'daki tazelik feragati **5 Ekim 2026**'da sona eriyor — o tarihte kapı yeniden kırmızıya döner.
- WebGL sahneleri masaüstü Chromium'da kabul testinden geçti; düşük güçlü mobil cihazlarda kare hızı için ölçüm yok.
- Yukarıdaki yıldız ve repo sayıları yalnızca herkese açık depoları kapsar.
- Ekonometri lisansım henüz başlamadı; buradaki iş öğrenme sürecinin çıktısıdır, akademik yayın değildir.
- Streamlit üzerindeki panel hareketsizlikte uykuya geçiyor; sürekli erişilebilirlik iddia edilmiyor. Uyumayan yüzey yukarıdaki kanıt sayfasıdır.
